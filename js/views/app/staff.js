...
<sc-if value="{{ tabStaff }}">
  ...
  <div style="background:rgba(251,248,241,.72);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.85);border-radius:14px;overflow:hidden;">
    <div style="display:grid;grid-template-columns:56px 1.6fr 1fr 1fr 160px;padding:12px 18px;font-size:12px;letter-spacing:1px;color:#7A8378;border-bottom:1px solid #E3DCCB;">
      <div>#</div><div>NAME</div><div>ID</div><div>ROLE</div><div></div>
    </div>
    <sc-for list="{{ staffRows }}" as="s">
      <div style="display:grid;grid-template-columns:56px 1.6fr 1fr 1fr 160px;padding:10px 18px;align-items:center;border-bottom:1px solid #F0EADB;font-size:14px;">
