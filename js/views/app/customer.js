...
<sc-if value="{{ tabCustomer }}">
  ...
  <div style="background:rgba(251,248,241,.72);backdrop-filter:blur(10px);border:1px solid rgba(255,255,255,.85);border-radius:14px;overflow:hidden;">
    <div style="display:grid;grid-template-columns:1.4fr 1.2fr 110px 90px 120px;padding:12px 18px;font-size:12px;letter-spacing:1px;color:#7A8378;border-bottom:1px solid #E3DCCB;">
      <div>NAME</div><div>PHONE</div><div>DEBT</div><div>ORDERS</div><div>LAST ORDER</div>
    </div>
    <sc-for list="{{ customerRows }}" as="c">
      <div style="display:grid;grid-template-columns:1.4fr 1.2fr 110px 90px 120px;padding:12px 18px;align-items:center;border-bottom:1px solid #F0EADB;font-size:14px;">
